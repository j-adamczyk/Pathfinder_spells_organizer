...
class SpellElements:
    ...
    descriptors = {"acid", "air", "chaotic", "cold", "curse", "darkness", "death",
                   ...
                   "force", "good", "language-dependent", "lawful", "light",
                   "mediative", "mind-affecting", "pain", "poison", "ruse",
                   "shadow", "sonic", "water"}
    ...
    bloodlines = {"unicorn sorcerer", "phoenix sorcerer", "salamander",
                  ...
                  "fey", "ghoul", "harrow", "imperious", "impossible", "infernal",
                  "kobold", "maestro", "marid", "martyred", "nanite", "oni",
                  "orc", "pestilence", "possessed", "protean", "psychic", "rakshasa",
                  "scorpion", "serpentine", "shadow", "shaitan", "solar",
                  "starsoul", "stormborn", "undead", "verdant", "vestige"
                  }
    domains = {"air", "animal", "artifice", "chaos", "charm", "community",
               ...
               "travel", "trickery", "vermin", "vermin", "void", "war", "water",
               "weather"}
    subdomains = {"cloud", "lightning", "wind", "feather", "fur", "insect",
                  ...
                  "education", "family", "home", "loss", "moon", "night", "murder",
                  "plague", "psychopomp", "undead", "catastrophe", "hatred", "rage",
                  "torture", "caves", "metal", "petrification", "radiation",
                  "cannibalism", "corruption", "daemon", "devil", "fear", "kyton",
                  "arson", "ash", "smoke", "heroism", "honor", "hubris", "legend",
                  "agathion", "archon", "friendship", "redemption", "medicine",
                  "restoration", "resurrection", "aeon", "espionage", "memory",
                  "thought", "inevitable", "judgment", "legislation", "loyalty",
                  "slavery", "tyranny", "freedom", "revolution", "self-realization",
                  "curse", "fate", "imagination", "insanity", "nightmare", "truth",
                  "arcane", "divine", "rites", "aristocracy", "leadership",
                  "martyr", "leshy", "decay", "growth", "thorns", "defense",
                  ...
                  "revelation", "thirst", "exploration", "portal", "trade", "ambush",
                  "deception", "greed", "innuendo", "thievery", "dark tapestry",
                  "isolation", "stars", "blood", "duels", "tactics", "flotsam",
                  "flowing", "ice", "oceans", "rivers", "monsoon", "seasons", "storms"}
    elemental_schools = {"aether, air", "earth", "fire", "metal", "void", "water", "wood"}
    ...
    range_types = {"personal", "touch", "close", "medium", "long", "unlimited", "other"}
    target_areas = {"single", "multiple", "area"}
    durations_names = {"instantaneous", "permanent", "concentration", "discharge", "round", "minute", "hour"}
